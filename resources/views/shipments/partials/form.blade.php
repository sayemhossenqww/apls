...
<form action="{{ isset($shipment) ? route('shipments.update', $shipment) : route('shipments.store') }}" method="POST"
    ...
    <div class="mb-3 row">
        <div class="mb-3 col-sm-6 col-md-6 col-lg-6">
            ...
            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="title"
                value="{{ old('title', isset($shipment) ? $shipment->title : '') }}" required>
            @error('title')
    ...
    <div class="mb-3 row">
        <div class="mb-3 col-sm-6 col-md-6 col-lg-6">
            ...
            @if(!empty($supplier_name))
                <input type="text" name="supplier_name[]" class="form-control @error('supplier_name') is-invalid @enderror"
                    id="suplier_name" value="{{ old('supplier_name', $shipment->supplier_name) }}">

            @else
                <input type="text" name="supplier_name" class="form-control @error('supplier_name') is-invalid @enderror"
                    id="suplier_name" required>
            @endif
        ...
        <div class="mb-3 col-sm-6 col-md-6 col-lg-6">
            ...
            @if(!empty($bar_code))
                <input type="text" name="bar_code" class="form-control @error('bar_code') is-invalid @enderror" id="result"
                    value="{{ old('bar_code', isset($bar_code) ? $bar_code[0] : '') }}" required>
            @else
    ...
    <div class="mb-3 row">
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('mode') is-invalid @enderror" id="mode" name="mode" required>
                    @if(!empty($shipment))
                        ...
                        <option value="By Plane" @if($shipment->mode == 'By Plane') selected @endif>
                            @lang('By Plane')
                        </option>
                        <option value="By Sea" @if($shipment->mode == 'By Sea') selected @endif>
                            @lang('By Sea')
                        </option>
                        <option value="By Land" @if($shipment->mode == 'By Land') selected @endif>
                            @lang('By Land')
                        </option>
        ...
        <div class="mb-3 row">
            <div class="mb-3 col-sm-6 col-md-6 col-lg-6">
                ...
                <input type="text" name="sum_weight" class="form-control @error('sum_weight') is-invalid @enderror"
                    id="weight" value="{{ old('sum_weight', isset($shipment) ? $shipment->sum_weight : '') }}" required>
                @error('sum_weight')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 col-sm-6 col-md-6 col-lg-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="total_price"
                        ...
                        value="{{ old('total_price', isset($shipment) ? $shipment->total_price : '') }}" required>
                    @error('total_price')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
...
@push('script')
    <script>
        ...
        html += '<div class="mb-3 row"><div class="mb-3 col-sm-6 col-md-6 col-lg-6"> <label for="name" class="form-label">Weight (In KG)</label><input type="text" name="weight[]" class="form-control "  id="weight"></div>';
