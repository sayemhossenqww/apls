    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3 d-flex align-items-stretch">
            <x-card class="clickable-cell">
                <div class="text-center">
                    <img src="{{ asset('images/webp/inbox.webp') }}" height="100" class="mb-3" alt="inbox">
                    <h3>@lang('Quotations')</h3>
                    <a href="{{ Auth::user()->is_cashier ? '#' : route('quotations.index') }}"
        ...
        <div class="col-md-4 mb-3 d-flex align-items-stretch">
            <x-card class="clickable-cell">
                <div class="text-center">
                    <img src="{{ asset('images/webp/credit-card.webp') }}" height="100" class="mb-3" alt="card">
                    <h3>@lang('Merchant Payments')</h3>
                    <a href="{{ route('supplier-payments.index') }}" class=" stretched-link"></a>
                </div>
            </x-card>
        </div>
        <div class="col-md-4 mb-3 d-flex align-items-stretch">
        ...
        <div class="col-md-4 mb-3 d-flex align-items-stretch">
            <x-card class="clickable-cell">
                <div class="text-center">
                    <img src="{{ asset('images/webp/fast-delivery.png') }}" height="100" class="mb-3" alt="gear">
                    <h3>@lang('Deliveries')</h3>
        ...
        <div class="col-md-4 mb-3 d-flex align-items-stretch">
            <x-card class="clickable-cell">
                <div class="text-center">
                    <img src="{{ asset('images/webp/procurement.webp') }}" height="100" class="mb-3" alt="gear">
                    <h3>@lang('Shipments')</h3>
