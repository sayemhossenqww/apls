        ...
        <div class="card-body">
            ...
            <div class="d-flex">
                <div class=" flex-grow-1">
                    <form action="{{ route('supplier-payments.index') }}" role="form" class="mb-3">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end animate slideIn shadow-sm"
                                            ...
                                            <li>
                                                <a class="dropdown-item" target="_blank"
                                                    href="{{ route('suppliers.payments.print', [$payment->supplier, $payment]) }}">
                                                    @lang('Print')
                                                </a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#">
                                                    <form
                                                        action="{{ route('suppliers.payments.destroy', [$payment->supplier, $payment]) }}"
