        ...
        var delivery_name =  this.state.selectDelivery;                
          httpService
            .post(`/order`, {
                ...
                delivery_id:this.state.selectDelivery,
                            ...
                            <select
                              ...
                              <select
                                        ...
                                        {this.state.deliveries.length > 0 &&
                                            this.state.deliveries.map((item: IDelivery) => <option value={item.id}>{item.name}</option>)}
                                    </select>
                            <select
                                name="is_zone"
                                id="is_zone"
                            ...
                            <div className="modal-body py-0">
                                <div className="row">
                                    <div className="col-6 py-3 bg-primary-sec">
                                        <table className="table table-borderless " style={{ background: "#142849" }}>
                                            <tbody>
                                                <tr>
